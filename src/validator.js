const validator = {
  ...
  maskify: (inputCardNumber) => {
    const mask = "#" 
    const maskedCardNumber = inputCardNumber.slice(0,-4).replace(/./g,mask) 
    return maskedCardNumber.concat(inputCardNumber.slice(-4)) // Retornar la concat de caracteres enmascarados y los últimos 4.  
  }
